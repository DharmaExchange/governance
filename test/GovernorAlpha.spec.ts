...
describe('GovernorAlpha', () => {
  ...
  it('dharma', async () => {
    const balance = await dharma.balanceOf(wallet.address)
    const totalSupply = await dharma.totalSupply()
  ...
  it('governor', async () => {
    ...
    const dharmaFromGovernor = await governorAlpha.dharma()
    expect(dharmaFromGovernor).to.be.eq(dharma.address)
  })
})
